...
namespace DualClock.Controls
{
    public partial class AnalogClock : UserControl
    {
        ...
        protected Canvas? _clockCanvas;
        protected Ellipse? _faceEllipse;
        protected Path? _hourHand;
        protected Path? _minuteHand;
        protected Path? _secondHand;
        protected Ellipse? _centerDot;
        protected TextBlock? _dateText;
        ...
        protected virtual void GenerateTicks(double radius, double centerX, double centerY)
        {
        ...
        protected virtual void ArrangeClock()
        {
